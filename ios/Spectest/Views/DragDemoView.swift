...
final class DragDemoViewModel {
  ...
  var lastMove: Any = ""
  var isSortable: Any { (specString(activeDemo) == specString("sortable")) }
  var isKanban: Any { (specString(activeDemo) == specString("kanban")) }
  ...
  var body: some View {
    VStack(spacing: CGFloat(20)) {
      ...
      VStack(spacing: CGFloat(16)) {
        if (specString(vm.activeDemo) == specString("sortable")) {
      ...
      VStack(spacing: CGFloat(16)) {
        if (specString(vm.activeDemo) == specString("kanban")) {
          HStack(alignment: .center, ) {
